...
mod test {
    ...
    fn should_find_correct_invalid_games() {
        assert_eq!(process_invalid_games("Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red"), 0);
        assert_eq!(process_invalid_games("Game 15: 3 green, 1 blue, 5 red; 2 red; 1 red, 4 green"), 15);
        assert_eq!(process_invalid_games("Game 100: 6 green, 15 red, 12 blue; 9 red; 16 red; 17 red, 3 blue, 7 green"), 0);
    }

    #[test]
    fn should_find_correct_power_of_games() {
        assert_eq!(process_power_of_games("Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green"), 48);
        assert_eq!(process_power_of_games("Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue"), 12);
        assert_eq!(process_power_of_games("Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red"), 1560);
        assert_eq!(process_power_of_games("Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red"), 630);
        assert_eq!(process_power_of_games("Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"), 36);
    }
}
